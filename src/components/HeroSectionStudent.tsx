...
export const HeroSectionStudent = () => {
          ...
          {!isSubmitted ? (
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
              ...
              <div className="flex-1 space-y-8 text-center lg:text-left">
                ...
                >
                  🚀 Let your cashflow unlock the uni experience
                </Badge>
                ...
                <div className="space-y-6">
                  <h1 className="text-4xl md:text-6xl font-black text-purple-900 leading-tight transform hover:scale-105 transition-transform duration-300">
                    ...
                    <span className="text-pink-600 underline decoration-wavy decoration-pink-400">installaments</span>
                  </h1>
                ...
                <p className="text-xl text-purple-700 max-w-2xl lg:max-w-none leading-relaxed font-medium">
                  You don't want it to be over by freshers. When it's gone, it's gone.
                </p>
